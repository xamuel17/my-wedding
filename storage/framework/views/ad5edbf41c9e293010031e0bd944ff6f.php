...
<div class="py-12 sm:py-20 bg-gray-50/50">
    <div class="container mx-auto px-4 sm:px-6">
        ...
        <div class="max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
            <form action="<?php echo e(route('donate.confirm')); ?>" method="POST" class="wedding-form bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="name" name="name" required value="<?php echo e(old('name')); ?>" class="w-full wedding-form-input" placeholder="John and Jane Doe">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-5">
                    ...
                    <input type="number" id="amount" name="amount" required min="1" step="0.01" value="<?php echo e(old('amount')); ?>" class="w-full wedding-form-input" placeholder="100.00">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-5">
                    ...
                    <textarea id="message" name="message" rows="4" class="w-full wedding-form-input resize-none" placeholder="Wishing you both a lifetime of love and happiness..."><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\wedding-site\resources\views/donate.blade.php ENDPATH**/ ?>