        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-6 sm:p-10 text-center relative overflow-hidden" data-aos="zoom-in">
                    ...
                    <div class="bg-gray-50 rounded-2xl p-5 sm:p-6 mb-8 text-left border border-gray-100" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                ...
                                <span class="font-nunito font-semibold text-gray-800"><?php echo e($donation['name']); ?></span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            ...
                            <?php if($donation['message']): ?>
                                <div class="py-2">
                                    ...
                                    <p class="font-nunito text-gray-600 italic bg-white p-4 rounded-xl border border-gray-100 text-sm leading-relaxed">"<?php echo e($donation['message']); ?>"</p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-center" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <a href="<?php echo e(route('wishes')); ?>" class="inline-flex items-center justify-center px-6 py-3 border-2 border-royal-purple text-royal-purple rounded hover:bg-royal-purple hover:text-white transition-all duration-300 font-nunito text-sm font-semibold uppercase tracking-wider">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\wedding-site\resources\views/donate-thankyou.blade.php ENDPATH**/ ?>