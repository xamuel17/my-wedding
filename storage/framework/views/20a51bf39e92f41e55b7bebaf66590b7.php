<?php $__env->startSection('title', 'RSVP - Olivia & Enrico Wedding'); ?>
    ...
    <div class="container mx-auto px-4 sm:px-6">
        <div class="max-w-2xl mx-auto" data-aos="fade-up">
            <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-10 border border-gray-100 relative overflow-hidden">
                ...
                <form action="<?php echo e(route('rsvp.store')); ?>" method="POST" class="wedding-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php if(session('success')): ?>
                        ...
                        <div class="text-center py-4">
                            ...
                            <p class="text-green-700 font-nunito font-semibold mb-4"><?php echo e(session('success')); ?></p>
                            ...
                            <?php if(session('zoom_link')): ?>
                                <div class="mt-4 p-5 bg-gray-50 border border-gray-200 rounded-xl text-left">
                                    ...
                                    <a href="<?php echo e(session('zoom_link')); ?>" target="_blank" rel="noopener"
                    ...
                    <?php else: ?>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="email" id="email" name="email" required value="<?php echo e(old('email')); ?>" class="w-full wedding-form-input" placeholder="john@example.com">
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <textarea id="message" name="message" rows="4" class="w-full wedding-form-input resize-none" placeholder="Share your well wishes or any dietary requirements..."><?php echo e(old('message')); ?></textarea>
                        </div>
    ...
    <div class="container mx-auto px-4 sm:px-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <?php
                    $details = [
                        ['icon' => 'ti-heart', 'title' => 'Wedding Ceremony', 'items' => ['December 15, 2026', '12:00 PM – 1:00 PM', '175 Broadway, Brooklyn'], 'icons' => ['ti-calendar', 'ti-time', 'ti-location-pin']],
                        ['icon' => 'ti-gift', 'title' => 'Wedding Reception', 'items' => ['December 15, 2026', '2:00 PM onwards', 'Fortune Brooklyn Restaurant'], 'icons' => ['ti-calendar', 'ti-time', 'ti-location-pin']],
                ...
                <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="text-center bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-400" data-aos="fade-up" data-aos-delay="<?php echo e($i * 100); ?>">
                        <div class="w-14 h-14 bg-gradient-to-br from-royal-purple to-lilac rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-lg shadow-royal-purple/20">
                            <i class="<?php echo e($detail['icon']); ?> text-white text-xl"></i>
                        </div>
                        <h4 class="font-cormorant text-xl text-royal-purple mb-4"><?php echo e($detail['title']); ?></h4>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $detail['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <p class="flex items-center justify-center text-gray-500 text-sm gap-2">
                                    <i class="<?php echo e($detail['icons'][$j]); ?> text-lilac text-xs"></i> <?php echo e($item); ?>
...
<div class="py-12 sm:py-16 bg-gradient-to-br from-wedding-pink to-white">
    <div class="container mx-auto px-4 sm:px-6 text-center" data-aos="fade-up">
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="mailto:olivia.enrico.wedding@example.com" class="inline-flex items-center justify-center px-6 py-3 bg-royal-purple text-white rounded-xl hover:bg-royal-purple/90 transition-all duration-300 text-sm font-nunito">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\wedding-site\resources\views/rsvp.blade.php ENDPATH**/ ?>