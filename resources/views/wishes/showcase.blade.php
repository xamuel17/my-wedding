...
@section('title', 'Wishes Showcase - Faith & Samuel — Together Forever')
    ...
    <div class="container mx-auto px-4 sm:px-6">
        ...
        @if(count($wishes) > 0)
                    ...
                    <div class="wish-card" data-aos="fade-up">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 class="font-cormorant text-lg text-gray-800 leading-tight">{{ $wish->name }}</h4>
                                    <p class="text-xs text-gray-400">{{ $wish->created_at->format('F j, Y') }}</p>
                                </div>
                            </div>
                            <i class="ti-heart text-lilac heart-animation text-sm"></i>
                        </div>

                        <p class="text-gray-600 leading-relaxed text-sm mb-3">{{ $wish->message }}</p>
            ...
            <div class="mt-12 sm:mt-16" data-aos="fade-up">
                <div class="bg-gradient-to-br from-wedding-pink to-white rounded-2xl p-6 sm:p-8 shadow-md">
                    <div class="grid grid-cols-3 gap-4 text-center">
                        <div>
                            <div class="text-2xl sm:text-3xl font-bold gradient-text font-nunito mb-1">{{ count($wishes) }}</div>
            ...
            <div class="text-center mt-10" data-aos="fade-up">
                <a href="{{ route('wishes') }}" class="inline-flex items-center justify-center px-8 py-4 border-2 border-royal-purple text-royal-purple rounded-xl hover:bg-royal-purple hover:text-white transition-all duration-300 font-nunito font-semibold text-sm">
